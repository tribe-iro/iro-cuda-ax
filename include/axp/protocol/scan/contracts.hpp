...
template<>
struct exec_lifetime<iro::exec::block> { using type = iro::token::lifetime::block; };
...
template<>
struct is_supported_exec_scan_warp<iro::exec::warp> : std::true_type {};

template<class ExecGroup>
struct is_supported_exec_scan_block : std::false_type {};

template<>
struct is_supported_exec_scan_block<iro::exec::block> : std::true_type {};

template<class ExecGroup>
struct is_supported_exec_scan_warpgroup : std::false_type {};

template<int Warps>
struct is_supported_exec_scan_warpgroup<iro::exec::warpgroup_t<Warps>> : std::true_type {};

template<class Subject, class ExecGroup>
using in_tokens = iro::util::concat_t<
    iro::util::type_list<iro::token::alive<Subject, exec_lifetime_t<ExecGroup>>>,
    axp::detail::participation_tokens<Subject, ExecGroup>
>;

template<class Subject, class ExecGroup>
using out_tokens = in_tokens<Subject, ExecGroup>;

template<class Subject>
using warp_lane0_tokens = iro::util::type_list<
    iro::token::alive<Subject, iro::token::lifetime::warp>,
    iro::token::lanes_valid<Subject, 1>
>;

template<class Subject, class ExecGroup>
using warpgroup_lane0_tokens = iro::util::type_list<
...
struct WarpScan {
    ...
    using inputs = iro::util::type_list<
        iro::contract::InputPort<
            ...
            Subj,
            ExecGroup,
            iro::util::concat_t<detail::in_tokens<Subj, ExecGroup>, InExtra>,
    ...
    using outputs = iro::util::type_list<
        iro::contract::OutputPort<
            ...
            Subj,
            ExecGroup,
            iro::util::concat_t<detail::out_tokens<Subj, ExecGroup>, OutExtra>,
            typename Payload::dist,
            Recipe
        >
    >;
...
struct ChainedScan {
    ...
    using inputs = iro::util::type_list<
        ...
        iro::contract::InputPort<
            ...
            CarryInSubj,
            ExecGroup,
            iro::util::concat_t<detail::in_tokens<CarryInSubj, ExecGroup>, InExtra>,
    ...
    using outputs = iro::util::type_list<
        ...
        iro::contract::OutputPort<
            ...
            CarryOutSubj,
            ExecGroup,
            iro::util::concat_t<detail::out_tokens<CarryOutSubj, ExecGroup>, OutExtra>,
            typename CarryPayload::dist,
            Recipe
        >
    >;
