...
struct registry_for {
    static_assert(detail::always_false_v<Obligation>,
                  "axp::kit::sm89::registry_for: unsupported obligation");
};
...
struct registry_for<axp::protocol::stage::IssueGmemToSmemSlot<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::IssueGmemToSmemSlot<Recipe, InTile, OutTile, InSubj, PipeTag, SlotSubj, ExecGroup, Lifetime, Slots, SwizzleAtom>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::stage::DirectGmemToSmemSlot<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::DirectGmemToSmemSlot<Recipe, InTile, OutTile, InSubj, PipeTag, SlotSubj, ExecGroup, Lifetime, Slots, SwizzleAtom>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::stage::CpAsyncIssue<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::CpAsyncIssue<Recipe, InTile, OutTile, InSubj, PipeTag, SlotSubj, ExecGroup, Lifetime, Slots, SwizzleAtom>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::stage::CpAsyncCommit<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::CpAsyncCommit<Recipe, OutTile, PipeTag, SlotSubj, ExecGroup, Lifetime, Slots>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::stage::CpAsyncWait<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::CpAsyncWait<Recipe, OutTile, PipeTag, SlotSubj, ExecGroup, Lifetime, Slots, Prior>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::stage::WaitSmemSlot<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::WaitSmemSlot<Recipe, OutTile, SlotSubj, ExecGroup, Lifetime>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::stage::ReadySmemSlot<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::ReadySmemSlot<Recipe, OutTile, SlotSubj, ExecGroup, Lifetime>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::stage::CommitSmemSlot<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::CommitSmemSlot<Recipe, OutTile, SlotSubj, BarrierSubj, ExecGroup, Lifetime>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::stage::ReleaseSmemSlot<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::ReleaseSmemSlot<Recipe, SlotSubj, ExecGroup, Lifetime>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::stage::MarkConsumed<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::MarkConsumed<Recipe, SlotSubj, ExecGroup, Lifetime, Bytes>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::stage::StoreSmemToGmemSlot<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::StoreSmemToGmemSlot<Recipe, InTile, OutTile, SlotSubj, OutSubj, ExecGroup, Lifetime>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::stage::PassSlot<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::PassSlot<Recipe, SlotSubj, ExecGroup, Lifetime, Bytes>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::compute::WarpMmaFromSmem<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::WarpMmaFromSmem<Recipe, Shape, ATile, BTile, AccFrag, ASubj, BSubj, AccSubj>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::compute::WarpMmaFromShared<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::WarpMmaFromShared<Recipe, Shape, ATile, BTile, AccFrag, ASubj, BSubj, AccSubj>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::reduction::BlockReduce<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::BlockReduce<Recipe, InTile, OutTile, InSubj, OutSubj, ExecGroup>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::reduction::WarpReduce<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::WarpReduce<Recipe, Frag, Subj, ExecGroup, OpTag>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::reduction::WarpAllReduce<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::WarpAllReduce<Recipe, Frag, Subj, ExecGroup, OpTag>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::reduction::WarpSegmentedReduce<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::WarpSegmentedReduce<Recipe, Frag, Subj, ExecGroup, OpTag, SegmentWidth>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::reduction::WarpgroupReduce<
    ...
    static_assert(iro::exec::warpgroup_warps<ExecGroup>::value <= iro::cap::sm89::warpgroup_warps,
                  "WarpgroupReduce: ExecGroup warps exceed sm89 capability");
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
...
struct registry_for<axp::protocol::mask::MaskGen<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::MaskGen<Recipe, MaskFragT, MaskSubj, ExecGroup>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::level0::LdGlobal<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::LdGlobal<Recipe, InTile, OutTile, InSubj, OutSubj, ExecGroup, CachePolicy, InDist, OutDist, InExtra, OutExtra>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::level0::StGlobal<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::StGlobal<Recipe, InTile, OutTile, InSubj, OutSubj, ExecGroup, CachePolicy, InDist, OutDist, InExtra, OutExtra>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::level0::PrefetchGlobal<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::PrefetchGlobal<Recipe, InTile, InSubj, ExecGroup, CachePolicy, InDist, InExtra>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::level0::LdShared<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::LdShared<Recipe, InTile, OutTile, InSubj, OutSubj, ExecGroup, InDist, OutDist, InExtra, OutExtra>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::level0::StShared<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::StShared<Recipe, InTile, OutTile, InSubj, OutSubj, ExecGroup, InDist, OutDist, InExtra, OutExtra>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::level0::SwizzledLdShared<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::SwizzledLdShared<Recipe, InTile, OutTile, InSubj, OutSubj, ExecGroup, SwizzleAtom, InDist, OutDist, InExtra, OutExtra>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::level0::SwizzledStShared<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::SwizzledStShared<Recipe, InTile, OutTile, InSubj, OutSubj, ExecGroup, SwizzleAtom, InDist, OutDist, InExtra, OutExtra>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::level0::WarpgroupScan<
    ...
    static_assert(iro::exec::warpgroup_warps<ExecGroup>::value <= iro::cap::sm89::warpgroup_warps,
                  "WarpgroupScan: ExecGroup warps exceed sm89 capability");
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
...
struct registry_for<axp::protocol::convert::CastTile<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::CastTile<RecipeIn, RecipeOut, InTile, OutTile, InSubj, OutSubj, ExecGroup, VecBytes, InDist, OutDist>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::convert::CastFragment<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::CastFragment<RecipeIn, RecipeOut, InFrag, OutFrag, InSubj, OutSubj, ExecGroup>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::convert::FragmentToVectorSlice<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::FragmentToVectorSlice<Recipe, Frag, Vec, FragSubj, VecSubj, ExecGroup, Offset>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::convert::VectorSliceToFragment<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::VectorSliceToFragment<
                Recipe, Frag, Vec, FragInSubj, VecSubj, FragOutSubj, ExecGroup, Offset>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::sync::SyncPoint<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::SyncPoint<Recipe, Subject, ExecGroup>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::sync::SyncWarp<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::SyncWarp<Recipe, Subject, ExecGroup>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::sync::SyncThreads<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::SyncThreads<Recipe, Subject, ExecGroup>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::sync::Fence<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::Fence<Recipe, Subject, ExecGroup, ScopeT, OrderT>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::sync::BarrierInit<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::BarrierInit<Recipe, Subject, ExecGroup, Expected>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::sync::BarrierArrive<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::BarrierArrive<Recipe, Subject, ExecGroup>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::sync::BarrierWait<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::BarrierWait<Recipe, Subject, ExecGroup>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::sync::BarrierTryWait<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::BarrierTryWait<Recipe, Subject, ExecGroup, FlagPayload, FlagSubj, OutExtra>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::sync::BarrierInvalidate<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::BarrierInvalidate<Recipe, Subject, ExecGroup, Expected>,
            iro::cap::sm89>
    >;
};

template<class Recipe, class InTile, class Frag, class InSubj, class FragSubj, class ExecGroup, class Lifetime>
struct registry_for<axp::protocol::ownership::TileToFragment<
    Recipe, InTile, Frag, InSubj, FragSubj, ExecGroup, Lifetime>> {
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::TileToFragment<Recipe, InTile, Frag, InSubj, FragSubj, ExecGroup, Lifetime>,
            iro::cap::sm89>
    >;
};

template<class Recipe, class Frag, class OutTile, class FragSubj, class OutSubj, class ExecGroup, class Lifetime>
struct registry_for<axp::protocol::ownership::FragmentToTile<
    Recipe, Frag, OutTile, FragSubj, OutSubj, ExecGroup, Lifetime>> {
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::FragmentToTile<Recipe, Frag, OutTile, FragSubj, OutSubj, ExecGroup, Lifetime>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::ownership::SharedTileToFragment<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::SharedTileToFragment<Recipe, InTile, Frag, InSubj, FragSubj, ExecGroup, Lifetime, InExtra, OutExtra>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::ownership::FragmentToSharedTile<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::FragmentToSharedTile<Recipe, Frag, OutTile, FragSubj, OutSubj, ExecGroup, Lifetime, InExtra, OutExtra>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::ownership::TileBoundaryIn<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::TileBoundaryIn<Recipe, Tile, Subj, ExecGroup, Lifetime, InExtra, OutExtra>,
            iro::cap::sm89>
    >;
};
...
struct registry_for<axp::protocol::ownership::TileBoundaryOut<
    ...
    using type = iro::util::type_list<
        iro::registry::RealizationEntry<
            axp::realize::sm89::TileBoundaryOut<Recipe, Tile, Subj, ExecGroup, Lifetime, InExtra, OutExtra>,
            iro::cap::sm89>
    >;
};
...
template<class Obligation>
using bind_t = iro::bind::lookup_realization_t<Obligation, iro::cap::sm89, registry_for_t<Obligation>>;
