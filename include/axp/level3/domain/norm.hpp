...
namespace axp::level3::domain::norm {
...
struct FragmentWelfordStateF32Realization
    : iro::contract::Realization<
        ...
        iro::util::fnv1a_64_cstr("axp.level3.domain.welford.fragment_state")> {
...
struct WarpAllReduceWelfordStateF32Realization
    : iro::contract::Realization<
        ...
        iro::util::fnv1a_64_cstr("axp.level3.domain.welford.warp_all_reduce")> {
    __device__ __forceinline__ static WelfordStateF32 execute(WelfordStateF32 s) {
#ifdef __CUDA_ARCH__
        const unsigned mask = __activemask();
        #pragma unroll
...
struct WelfordStateMeanInvStdF32Realization
    : iro::contract::Realization<
        ...
        iro::util::fnv1a_64_cstr("axp.level3.domain.welford.mean_inv_std")> {
...
struct WelfordStateInvRmsF32Realization
    : iro::contract::Realization<
        ...
        iro::util::fnv1a_64_cstr("axp.level3.domain.welford.inv_rms")> {
    using eps_t = typename EpsPayload::elem::storage_t;
...
struct WelfordStateMeanF32Realization
    : iro::contract::Realization<
        ...
        iro::util::fnv1a_64_cstr("axp.level3.domain.welford.mean")> {
...
struct WelfordStateVarF32Realization
    : iro::contract::Realization<
        ...
        iro::util::fnv1a_64_cstr("axp.level3.domain.welford.var")> {
    using out_t = typename OutPayload::elem::storage_t;
...
struct norm_state_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.norm.state"); };
struct norm_mean_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.norm.mean"); };
struct norm_invstd_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.norm.invstd"); };
struct norm_invrms_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.norm.invrms"); };
struct norm_mean_frag_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.norm.mean_frag"); };
struct norm_inv_frag_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.norm.inv_frag"); };
...
struct layernorm_frag_impl {
    ...
    using MeanFrag = axp::level2::FragmentBroadcast<
        Recipe, Frag, EpsPayload, norm_mean_subj, norm_mean_frag_subj, ExecGroup,
        iro::util::type_list<>, iro::util::type_list<>, CapT
    >;
    using InvFrag = axp::level2::FragmentBroadcast<
        Recipe, Frag, EpsPayload, norm_invstd_subj, norm_inv_frag_subj, ExecGroup,
        iro::util::type_list<>, iro::util::type_list<>, CapT
    >;
    using Sub = axp::level2::low::Sub<Recipe, Frag, InSubj, norm_mean_frag_subj, norm_mean_frag_subj, ExecGroup>;
    using Mul = axp::level2::low::Mul<Recipe, Frag, norm_mean_frag_subj, norm_inv_frag_subj, norm_inv_frag_subj, ExecGroup>;
    using Scale = axp::level2::low::Mul<Recipe, Frag, norm_inv_frag_subj, GammaSubj, norm_inv_frag_subj, ExecGroup>;
    using Shift = axp::level2::low::Add<Recipe, Frag, norm_inv_frag_subj, BetaSubj, OutSubj, ExecGroup>;
...
struct rmsnorm_frag_impl {
    ...
    using InvFrag = axp::level2::FragmentBroadcast<
        ...
        iro::util::type_list<>, iro::util::type_list<>, CapT
    >;
    using Mul = axp::level2::low::Mul<Recipe, Frag, InSubj, norm_inv_frag_subj, norm_inv_frag_subj, ExecGroup>;
    using Scale = axp::level2::low::Mul<Recipe, Frag, norm_inv_frag_subj, WeightSubj, OutSubj, ExecGroup>;
...
struct resolve_impl<FragmentWelfordPattern<Recipe, Frag, InSubj, OutSubj, ExecGroup>, Cap,
    ...
    using type = axp::level3::domain::norm::FragmentWelfordStateF32<Recipe, Frag, InSubj, OutSubj, ExecGroup>;
};
...
struct resolve_impl<WarpAllReduceWelfordPattern<Recipe, InSubj, OutSubj>, Cap> {
    static constexpr bool supported = true;
    using type = axp::level3::domain::norm::WarpAllReduceWelfordStateF32<Recipe, InSubj, OutSubj>;
};
...
struct resolve_impl<LayerNormFragPattern<Recipe, Frag, GammaFrag, BetaFrag, EpsPayload,
                    ...
                    std::enable_if_t<std::is_same_v<ExecGroup, iro::exec::warp>>> {
    static constexpr bool supported = true;
    using type = typename axp::level3::domain::norm::detail::layernorm_frag_impl<
...
struct resolve_impl<RMSNormFragPattern<Recipe, Frag, WeightFrag, EpsPayload,
                    ...
                    std::enable_if_t<std::is_same_v<ExecGroup, iro::exec::warp>>> {
    static constexpr bool supported = true;
    using type = typename axp::level3::domain::norm::detail::rmsnorm_frag_impl<
...
struct resolve_impl<RowMeanPattern<Recipe, Frag, InSubj, OutSubj, ExecGroup>, Cap,
    ...
    using State = axp::level3::domain::norm::FragmentWelfordStateF32<Recipe, Frag, InSubj, axp::level3::domain::norm::detail::norm_state_subj, ExecGroup>;
    using AllReduce = axp::level3::domain::norm::WarpAllReduceWelfordStateF32<Recipe, axp::level3::domain::norm::detail::norm_state_subj,
                                                                     axp::level3::domain::norm::detail::norm_state_subj>;
    using Mean = axp::level3::domain::norm::WelfordStateMeanF32<Recipe, OutPayload,
                                                       axp::level3::domain::norm::detail::norm_state_subj, OutSubj, ExecGroup>;
    ...
    >;
    using type = axp::level3::detail::make_composition_t<obligations, edges, iro::profile::BudgetMax, Cap>;
};
...
struct resolve_impl<RowVariancePattern<Recipe, Frag, InSubj, OutSubj, ExecGroup>, Cap,
    ...
    using AllReduce = axp::level3::domain::norm::WarpAllReduceWelfordStateF32<Recipe, axp::level3::domain::norm::detail::norm_state_subj,
                                                                     axp::level3::domain::norm::detail::norm_state_subj>;
    using Var = axp::level3::domain::norm::WelfordStateVarF32<Recipe, OutPayload,
                                                     axp::level3::domain::norm::detail::norm_state_subj, OutSubj, ExecGroup>;
