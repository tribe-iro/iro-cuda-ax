...
#include "../../../level2/mask.hpp"
#include "../../domain/registry.hpp"
#ifdef __CUDACC__
#include <cuda_runtime.h>
#endif

namespace axp::level3::domain::attention {
...
struct softmax_state_max_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.softmax_state.max"); };
struct softmax_state_max_b_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.softmax_state.max_b"); };
struct softmax_state_sum_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.softmax_state.sum"); };
struct softmax_state_sum_b_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.softmax_state.sum_b"); };
struct softmax_state_inv_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.softmax_state.inv"); };
struct softmax_state_tmp_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.softmax_state.tmp"); };
struct softmax_state_inv_frag_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.softmax_state.inv_frag"); };
struct softmax_mask_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.softmax.mask"); };
struct softmax_neg_inf_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.softmax.neg_inf"); };
struct softmax_masked_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.softmax.masked"); };
struct softmax_neg_inf_frag_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.softmax.neg_inf_frag"); };
...
struct WarpSoftmaxStateF32 {
    ...
    using ReduceMaxFrag = axp::level2::low::FragmentReduceAcc<
        Recipe, Frag, ScalarAcc, InSubj, detail::softmax_state_max_subj, Exec, axp::level2::proto::reduction::op_max
    >;
    using ReduceMaxWarp = axp::level2::WarpReduce<
        AccRecipe, ScalarAcc, detail::softmax_state_max_subj, Exec, axp::level2::low::Max, CapT
    >;
    ...
    using FragMax = axp::level2::FragmentBroadcast<
        ...
        iro::util::type_list<>, iro::util::type_list<>, CapT
    >;
    using Sub = axp::level2::low::Sub<Recipe, Frag, InSubj, detail::softmax_state_tmp_subj, detail::softmax_state_tmp_subj, Exec>;
    using Exp = axp::level2::low::Exp<Recipe, Frag, detail::softmax_state_tmp_subj, detail::softmax_state_tmp_subj, Exec>;

    using ReduceSumFrag = axp::level2::low::FragmentReduceAcc<
        Recipe, Frag, ScalarAcc, detail::softmax_state_tmp_subj, detail::softmax_state_sum_subj, Exec, axp::level2::proto::reduction::op_add
    >;
    using ReduceSumWarp = axp::level2::WarpReduce<
        AccRecipe, ScalarAcc, detail::softmax_state_sum_subj, Exec, axp::level2::low::Add, CapT
    >;
    using BroadcastSum = axp::level2::BroadcastLane0<
        ...
        iro::util::type_list<>, iro::util::type_list<>, CapT
    >;
    using InvSum = axp::level2::low::Rcp<AccRecipe, ScalarAcc, detail::softmax_state_sum_b_subj, detail::softmax_state_inv_subj, Exec>;
    using FragInv = axp::level2::FragmentBroadcast<
        ...
        iro::util::type_list<>, iro::util::type_list<>, CapT
    >;
    using Mul = axp::level2::low::Mul<Recipe, Frag, detail::softmax_state_tmp_subj, detail::softmax_state_inv_frag_subj, OutSubj, Exec>;
...
struct WarpSoftmaxStateMaskedF32 {
    ...
    using ReduceMaxFrag = axp::level2::low::FragmentReduceAcc<
        Recipe, Frag, ScalarAcc, detail::softmax_masked_subj, detail::softmax_state_max_subj, Exec, axp::level2::proto::reduction::op_max
    >;
    using ReduceMaxWarp = axp::level2::WarpReduce<
        AccRecipe, ScalarAcc, detail::softmax_state_max_subj, Exec, axp::level2::low::Max, CapT
    >;
    ...
    using FragMax = axp::level2::FragmentBroadcast<
        ...
        iro::util::type_list<>, iro::util::type_list<>, CapT
    >;
    using Sub = axp::level2::low::Sub<Recipe, Frag, detail::softmax_masked_subj, detail::softmax_state_tmp_subj, detail::softmax_state_tmp_subj, Exec>;
    using Exp = axp::level2::low::Exp<Recipe, Frag, detail::softmax_state_tmp_subj, detail::softmax_state_tmp_subj, Exec>;
...
struct WarpgroupSoftmaxStateF32 {
    ...
    using ReduceMaxFrag = axp::level2::low::FragmentReduceAcc<
        Recipe, Frag, ScalarAcc, InSubj, detail::softmax_state_max_subj, Exec, axp::level2::proto::reduction::op_max
    >;
    using ReduceMaxGroup = axp::level2::WarpgroupReduce<
        AccRecipe, ScalarAcc, detail::softmax_state_max_subj, Exec, axp::level2::proto::reduction::op_max, kBarrierMax,
        iro::exec::warpgroup_warps<Exec>::value, CapT
    >;
    using BroadcastMax = axp::level2::WarpgroupBroadcastLane0<
    ...
    using ReduceSumFrag = axp::level2::low::FragmentReduceAcc<
        Recipe, Frag, ScalarAcc, detail::softmax_state_tmp_subj, detail::softmax_state_sum_subj, Exec, axp::level2::proto::reduction::op_add
    >;
    using ReduceSumGroup = axp::level2::WarpgroupReduce<
        AccRecipe, ScalarAcc, detail::softmax_state_sum_subj, Exec, axp::level2::proto::reduction::op_add, kBarrierSum,
        iro::exec::warpgroup_warps<Exec>::value, CapT
    >;
    using BroadcastSum = axp::level2::WarpgroupBroadcastLane0<
...
struct online_state_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.online.state"); };
...
struct AttentionWgmmaImpl {
    ...
    struct wgmma_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.wgmma"); };
    struct qk_frag_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.qk_frag"); };
    struct qk_raw_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.qk_raw"); };
    struct weights_frag_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.weights_frag"); };
    struct tile_state_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.tile_state"); };
    struct combined_state_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.combined_state"); };
    struct scale_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.scale"); };
    struct scale_frag_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.scale_frag"); };
    struct weights_scaled_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.weights_scaled"); };
    struct weights_f32_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.weights_f32"); };
    struct weights_f16_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.weights_f16"); };
    struct pv_raw_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.pv_raw"); };
    struct pv_frag_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.pv_frag"); };
    struct q_desc_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.q_desc"); };
    struct k_desc_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.k_desc"); };
    struct p_desc_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.p_desc"); };
    struct v_desc_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.v_desc"); };
    struct q_pipe_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.q_pipe"); };
    struct k_pipe_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.k_pipe"); };
    struct v_pipe_tag { static constexpr auto id = iro::util::fnv1a_64_cstr("axp.level3.domain.attn.v_pipe"); };
    ...
    using FenceQImpl = axp::level2::low::TileFence<
        Recipe, QTileS, SlotQ, iro::exec::block
    >;
    using FenceKImpl = axp::level2::low::TileFence<
        Recipe, KTileS, SlotK, iro::exec::block
    >;
    using FenceVImpl = axp::level2::low::TileFence<
    ...
    using QDesc = axp::level2::low::WgmmaSmemDesc<QTileS, SlotQ, WgmmaSwizzleQ>;
    using KDesc = axp::level2::low::WgmmaSmemDesc<KTileS, SlotK, WgmmaSwizzleK>;
    using PDesc = axp::level2::low::WgmmaSmemDesc<PTileSlice, weights_f16_subj, WgmmaSwizzleP>;
    using VDesc = axp::level2::low::WgmmaSmemDesc<VTileSlice, SlotV, WgmmaSwizzleV>;

    struct MakeDescQImpl : axp::level2::low::MakeDesc<
        Recipe, QTileS, SlotQ, q_desc_subj, ExecGroup, iro::token::lifetime::block, WgmmaSwizzleQ
    > {};
    struct MakeDescKImpl : axp::level2::low::MakeDesc<
    ...
    using SoftmaxImpl = std::conditional_t<
        kTileSkip,
        axp::level3::domain::attention::WarpSoftmaxStateMasked<
    ...
    struct tile_skip_mask<Enable, std::enable_if_t<Enable>> {
        ...
        struct CausalMaskImpl : axp::level2::CausalMask<
        ...
        > {};
        struct NegInfConstImpl : axp::level2::low::ScalarConst<
    ...
    using StoreWeightsImpl = axp::level2::low::FragmentToSharedTile<
        AccRecipe, QKFrag, PTileF32, weights_scaled_subj, weights_f32_subj, ExecGroup, iro::token::lifetime::warpgroup
    >;
    using WeightsFenceImpl = axp::level2::low::TileFence<
        AccRecipe, PTileF32, weights_f32_subj, ExecGroup
    >;
    using CastWeightsImpl = axp::level2::low::CastTile<
    ...
    struct pv_slice {
        ...
        using AddImpl = axp::level2::low::Add<
...
struct resolve_impl<SoftmaxStateCombinePattern<Recipe, ExecGroup, ASubj, BSubj, OutSubj>, Cap,
                    std::enable_if_t<axp::level3::domain::attention::is_supported_exec<ExecGroup>::value>> {
    static constexpr bool supported = true;
    using type = axp::level3::domain::attention::CombineSoftmaxStateF32<Recipe, ExecGroup, ASubj, BSubj, OutSubj>;
};
...
struct resolve_impl<WarpSoftmaxStatePattern<Recipe, Frag, InSubj, OutSubj, StateSubj, ExecGroup>, Cap,
    ...
    static constexpr bool supported = true;
    using type = typename axp::level3::domain::attention::WarpSoftmaxStateF32<
...
struct resolve_impl<WarpSoftmaxStatePattern<Recipe, Frag, InSubj, OutSubj, StateSubj, ExecGroup>, Cap,
    ...
    static constexpr bool supported = true;
    using type = typename axp::level3::domain::attention::WarpgroupSoftmaxStateF32<
        Recipe, Frag, InSubj, OutSubj, StateSubj, ExecGroup, Cap
    >::type;
};
...
struct resolve_impl<WarpSoftmaxStateMaskedPattern<
    ...
    std::enable_if_t<std::is_same_v<ExecGroup, iro::exec::warp>>> {
    static constexpr bool supported = true;
    using type = typename axp::level3::domain::attention::WarpSoftmaxStateMaskedF32<
        Recipe, Frag, MaskPayload, MaskSubj, NegInfSubj, InSubj, OutSubj, StateSubj, ExecGroup, Cap
    >::type;
};
...
struct resolve_impl<WarpSoftmaxStateMaskedPattern<
    ...
    std::enable_if_t<iro::exec::is_warpgroup_v<ExecGroup>>> {
    static constexpr bool supported = true;
    using type = typename axp::level3::domain::attention::WarpgroupSoftmaxStateMaskedF32<
        Recipe, Frag, MaskPayload, MaskSubj, NegInfSubj, InSubj, OutSubj, StateSubj, ExecGroup, Cap
    >::type;
};
...
struct resolve_impl<WarpReduceSoftmaxStatePattern<Recipe, InSubj, OutSubj>, Cap> {
    static constexpr bool supported = true;
    using type = axp::level3::domain::attention::WarpReduceSoftmaxStateF32<Recipe, InSubj, OutSubj>;
};
...
struct resolve_impl<SoftmaxStateCopyPattern<Recipe, InSubj, OutSubj, ExecGroup>, Cap,
                    std::enable_if_t<axp::level3::domain::attention::is_supported_exec<ExecGroup>::value>> {
    static constexpr bool supported = true;
    using type = axp::level3::domain::attention::SoftmaxStateCopyF32<Recipe, InSubj, OutSubj, ExecGroup>;
};
...
struct resolve_impl<SoftmaxStateScalePattern<Recipe, TileStateSubj, NewStateSubj, OutSubj, ExecGroup>, Cap,
                    std::enable_if_t<axp::level3::domain::attention::is_supported_exec<ExecGroup>::value>> {
    static constexpr bool supported = true;
    using type = axp::level3::domain::attention::SoftmaxStateScaleF32<Recipe, TileStateSubj, NewStateSubj, OutSubj, ExecGroup>;
};
...
struct resolve_impl<RescaleAccumulatorPattern<Recipe, AccFrag, AccSubj, OldStateSubj, NewStateSubj, ExecGroup>, Cap,
                    std::enable_if_t<axp::level3::domain::attention::is_supported_exec<ExecGroup>::value>> {
    static constexpr bool supported = true;
    using type = axp::level3::domain::attention::RescaleAccumulatorF32<Recipe, AccFrag, AccSubj, OldStateSubj, NewStateSubj, ExecGroup>;
};
...
struct resolve_impl<OnlineSoftmaxUpdatePattern<Recipe, AccFrag, AccSubj, OldStateSubj, NewStateSubj, OutStateSubj, ExecGroup>, Cap,
                    std::enable_if_t<axp::level3::domain::attention::is_supported_exec<ExecGroup>::value>> {
    static constexpr bool supported = true;
    using type = typename axp::level3::domain::attention::detail::online_softmax_update_impl<
...
struct resolve_impl<AttentionWgmmaPattern<Recipe, TileM, TileN, HeadDim, Stages,
    ...
    static constexpr bool supported = true;
    using type = typename axp::level3::domain::attention::AttentionWgmmaImpl<
        Recipe, TileM, TileN, HeadDim, Stages,
        QSubj, KSubj, VSubj,
