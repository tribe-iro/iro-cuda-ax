...
template struct axp::level3::registry::resolve_impl<SoftmaxRow4, iro::cap::sm89>;
...
template struct axp::level3::registry::resolve_impl<Gemm16x16x16, iro::cap::sm90>;
...
template struct axp::level3::registry::resolve_impl<Attention16x16, iro::cap::sm90>;
...
template struct axp::level3::registry::resolve_impl<SoftmaxRow4, iro::cap::sm90>;
